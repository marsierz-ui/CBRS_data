#!/usr/bin/env python3
"""Collect CBRS (Cerebras Systems) market data and store it as per-day CSV files."""
...
TICKER = "CBRS"          # Yahoo symbol
RIC = "CBRS.O"           # LSEG RIC for Nasdaq listing (IPO 2026-05-14)
...
def collect_lseg_data() -> None:
    ...
    backfill_days = int(os.environ.get("LSEG_BACKFILL_DAYS", "2"))
    try:
